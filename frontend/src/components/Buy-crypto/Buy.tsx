...
const Buy = () => {
    ...
    const [sessionId, setSessionId] = useState(process.env.NEXT_PUBLIC_SECTION_ID);
    ...
    return (
        <Box  bg="whiteAlpha.50" width="100%" height="100%" >
            ...
            <div className="w-full mt-8 justify-center text-center">
              <Text justifyContent="center" fontSize={30} fontWeight="bold">Buy Crypto with your credit card</Text>
            </div>
            <div className="w-full justify-center p-20 ">
                ...
                <div className="w-full h-[50vh] justify-center mt-10">
                    ...
                    />
                    <br />
                    <Button isLoading={loading} colorScheme="blue" onClick={handleCreateSession}>
                       Create session
                    </Button>
                </div>
