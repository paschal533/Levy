...
const Sidebar = () => {
  ...
  return (
    ...
    >
      ...
      <Box gap={4} py={6} px={4} mt={20}>
        <Flex
          onClick={() => {
            setItem("profile"), onClick("profile");
          }}
          py={2}
          px={2}
          borderRadius={5}
          color={`${item == "profile" && "#4FD8E0"}`}
          bg={`${item == "profile" && "whiteAlpha.200"}`}
        ...
        <Flex
          ...
          py={2}
          px={2}
          color={`${item == "chat" && "#4FD8E0"}`}
          bg={`${item == "chat" && "whiteAlpha.200"}`}
          borderRadius={5}
          _hover={{ cursor: "pointer", bg: "whiteAlpha.300" }}
          alignItems="center"
          alignContent="center"
        ...
        <Flex
          ...
          py={2}
          px={2}
          color={`${item == "nft" && "#4FD8E0"}`}
          bg={`${item == "nft" && "whiteAlpha.200"}`}
          borderRadius={5}
          _hover={{ cursor: "pointer", bg: "whiteAlpha.300" }}
          alignItems="center"
          alignContent="center"
        ...
        <Flex
          ...
          py={2}
          px={2}
          color={`${item == "buy" && "#4FD8E0"}`}
          bg={`${item == "buy" && "whiteAlpha.200"}`}
          borderRadius={5}
          _hover={{ cursor: "pointer", bg: "whiteAlpha.300" }}
          alignItems="center"
          alignContent="center"
