...
import CoinNameRow from "../Tokens/coinNameRow";
import Rate from "./rate";
import { useRouter } from "next/router";

const styles = {
  tableRow: `text-white border-b p-4  border-gray-800 text-[0.93rem]`,
};
...
const CMCtableRow = ({
  ...
  const viewCoinDetails = () => {
    router.push({ query: { page : `/currencies/info?symbol=${coinSymbol}&coin=${coinName}&price=${price}` } });
  };
